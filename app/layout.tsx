...
export default async function RootLayout({
  ...
  const theme = await getThemeOverride();
  ...
  return (
    <html lang={locale} data-theme={theme ?? undefined}>
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Geist:wght@400;500;600;700;800;900&family=Geist+Mono:wght@400;500&family=Syne:wght@500;600;700;800&family=Inter:wght@300;400;500;600&family=JetBrains+Mono:wght@400;500&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>
