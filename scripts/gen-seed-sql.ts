...
const DUOS: Duo[] = [
  ...
  { grupo: "Híbridos", tipo: "pareja", clase: "The Athlete", semanas: 9, consistencia: 0.85, racha: 6, rutina: [{ slug: "gym", freq: 3 }, { slug: "running", freq: 2 }], miembros: [m("Iván", "demo+ivan@dovofit.com", "masculino", 30, 80, 176, "ganar_musculo"), m("Tono", "demo+tono@dovofit.com", "masculino", 32, 84, 180, "ganar_musculo")] },
